...
This is a simple project developed in C# by using [helix-tookit](https://github.com/helix-toolkit/helix-toolkit). In order to compile this project the DLLs of Helix need to be compiled by downloading the source code from the helix repository and compiling them. An easier path is to [follow instructions in the Usage section](./REaDME_Customization.md#usage) of the customization guide.
